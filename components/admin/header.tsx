      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative hidden md:block group">
          ...
          <input 
            ...
            className="bg-slate-50 border border-slate-100 rounded-xl py-2 pl-10 pr-4 text-sm focus:outline-none focus:border-teal-500/50 focus:ring-4 focus:ring-teal-500/5 transition-all w-64"
          />
        </div>
