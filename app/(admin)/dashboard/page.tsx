...
export default function DashboardPage() {
  ...
  if (isLoading) return (
    <div className="flex flex-col items-center justify-center h-96 gap-4">
      ...
      <p className="text-slate-400 font-bold animate-pulse uppercase tracking-[0.2em] text-xs">Memuat Data Panel...</p>
    </div>
  );
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 lg:col-span-2 relative overflow-hidden group">
          <div className="flex justify-between items-center mb-8 relative z-10">
            ...
            <div className="flex items-center gap-2 text-sm font-black text-emerald-600 bg-emerald-50 px-4 py-2 rounded-2xl shadow-sm border border-emerald-100 rotate-1 transition-transform group-hover:rotate-0">
        ...
        <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 flex flex-col items-center justify-center text-center group">
          <h3 className="font-extrabold text-slate-800 text-xl tracking-tight mb-2">Pencapaian Target NGO</h3>
          <p className="text-xs text-slate-400 font-bold uppercase tracking-widest mb-10">Tahun Berjalan (YTD)</p>
          ...
          <div className="mt-8 w-full bg-slate-50 p-6 rounded-3xl border border-slate-100 space-y-3 transition-colors group-hover:bg-slate-100/50">
            <div className="flex justify-between text-sm">
              <span className="text-slate-400 font-bold uppercase tracking-widest text-[10px]">Terkumpul</span>
